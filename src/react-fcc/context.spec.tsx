...
import { TextComponent, TextComponentMappedActions } from './test-components/TextComponent'
...
test('initial state can be set', () => {
  const { ProviderContainer: TextProvider, withContext: withText } = context(
    { text: 'initial' },
    {
      updateText,
    },
  ...
  const component = renderer.create(
    <TextProvider>
      <TextComponentWithContext foo="test" />
    </TextProvider>,
  )
